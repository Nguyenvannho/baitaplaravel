...
Route::get('tasks/{taskId}', [TaskController::class, 'update'])->name('tasks.update');
Route::get('tasks/{photo}', [TaskController::class, 'destroy'])->name('tasks.destroy');

});



Route::get('/tinh', [MaytinhController::class, 'index'])->name('maytinh.index');
Route::post('/tinhketqua', [MaytinhController::class, 'tinh'])->name('tinh.tinh');
